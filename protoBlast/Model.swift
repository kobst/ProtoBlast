...
//                    
//            
//                    let fetchedData = ShapeV5.MessageData(message: messageText, senderName: sender.0, idImage: #imageLiteral(resourceName: "Image"), dist: sender.1, time: Double(randTime))
//                    
//                    let fetchedShape = ShapeV5(message: fetchedData)
//                    
//                    
